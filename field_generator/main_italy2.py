...
DEFAULT_CONFIG = {
    ...
    "tree_alternate_offset": 10, # offset applied only to odd rows ### slight randomization
    "tree_xspace": 35, # x space between trees (in float pixels) from center to center ### randomization +-10
    "tree_yspace": 25, # y space between trees (in float pixels) ### randomization +-10
    ...
    "treeshape_max_radius": 14, # maximum tree radius ### randomization 10 to 14
